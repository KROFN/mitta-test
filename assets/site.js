...
function home(){
 const featured=['laguna','mija-a','kotenok','adam-1','gloria'].map(s=>products.find(p=>p.slug===s));
 return `${header()}<main>
<section class="hero"><div class="hero-media">${img(media.hero,'Выставочный зал «Митта» с рядами мягкой мебели','',true)}</div><div class="hero-inner"><div class="hero-copy"><div class="eyebrow">Мебельный магазин · Бологое</div><h1>Мебель<br>в Бологом</h1><p class="hero-intro">Посмотрите ассортимент до поездки — а затем приезжайте в настоящий выставочный зал и выбирайте мебель вживую.</p><div class="hero-actions"><a class="btn blue" href="/catalog/">Смотреть каталог</a><a class="btn light" href="/store/">Как нас найти</a></div></div><aside class="hero-note"><b>Сначала посмотреть.</b>Реальные фото, конкретные модели и характеристики помогают приехать уже с коротким списком.</aside><div class="trust-rail"><div class="trust-item"><span class="trust-num">4,9</span><span class="trust-desc">89 оценок на Яндексе</span></div><div class="trust-item"><span class="trust-num">700+ м²</span><span class="trust-desc">зал · по данным самой «Митты»</span></div><div class="trust-item"><span class="trust-num">с 1998</span><span class="trust-desc">ООО «Митта» зарегистрировано в 1998 году</span></div></div></div></section>
<section class="section categories"><div class="section-head"><h2 class="section-title">Восемь<br>направлений</h2><div><p class="section-lead">Выберите комнату или тип мебели — и быстро поймите, что стоит посмотреть в зале.</p><p class="section-meta">В каждой категории — только материалы, связанные с реальным ассортиментом «Митты».</p></div></div><div class="cat-grid">${cats.map(catCard).join('')}</div></section>
<section class="bridge"><div class="bridge-grid"><div><div class="eyebrow">До поездки</div><h2>Сначала<br>увидеть.</h2><p>Смотрите реальные фотографии магазина и товаров, сохраняйте название модели и сразу задавайте вопрос по актуальной цене или наличию.</p><a class="bridge-link" href="/catalog/">Перейти к ассортименту →</a></div><div class="bridge-media">${img(media.bridge,'Кровати и матрасы в выставочном зале «Митта»')}</div></div></section>
<section class="section products-sec"><div class="section-head"><h2 class="section-title">Что уже<br>можно выбрать</h2><div><p class="section-lead">Пять конкретных позиций с реальными фотографиями и подтверждёнными деталями.</p><p class="section-meta">Старые цены не выдаются за текущие: дата или оговорка стоят рядом с ценой.</p></div></div><div class="product-editorial product-editorial-rich">${productCard(featured[0],'feat-laguna')}${productCard(featured[1],'feat-mija')}${productCard(featured[2],'feat-kotenok')}${productCard(featured[3],'feat-adam')}${productCard(featured[4],'feat-gloria')}</div><div class="products-bottom"><a class="bridge-link" href="/catalog/">Все 15 подтверждённых позиций →</a></div></section>
<section class="showroom-chapter"><div class="showroom-hero">${img(media.showroom,'Ряды диванов в выставочном зале «Митта»')}<div class="showroom-word">Вживую.</div></div><div class="showroom-content"><p class="showroom-statement">Сайт не заменяет магазин. Он помогает приехать уже с конкретными вариантами.</p><div class="showroom-facts"><div class="fact"><h4>Адрес</h4><p>Ветка Холодильника, 9<br>Бологое</p></div><div class="fact"><h4>В магазине</h4><p>Мебель можно сравнить и посмотреть в реальном масштабе.</p></div><div class="fact"><h4>Получение</h4><p>Доступны доставка и самовывоз.</p></div><div class="fact"><h4>Оплата</h4><p>Наличные · карта · СБП · безнал · кредит.</p></div></div><div class="showroom-peeks"><figure>${img(media.storeKitchen,'Кухонные гарнитуры в выставочном зале')}</figure><figure>${img(media.storeCorner,'Кровать и корпусная мебель в выставочном зале')}</figure></div><div class="showroom-actions"><a class="btn light" href="/store/">Посмотреть магазин</a><a class="btn light" target="_blank" rel="noopener" href="https://yandex.ru/maps/org/mitta/1075173904">Маршрут ↗</a></div></div></section>
<section class="section reputation"><div class="section-head"><h2 class="section-title">Репутация<br>без витрины</h2><p class="section-lead">Рейтинг и короткие выдержки из реального профиля магазина на Яндексе.</p></div><div class="rating-grid"><div class="rating-big">4,9</div><div class="rating-side"><div class="review-source"><span>Яндекс Карты</span><span>89 оценок · 34 отзыва</span></div><blockquote class="quote">«Заказ пришёл раньше заявленного»<small>Фрагмент реального отзыва</small></blockquote><blockquote class="quote">«Помогли с выбором, сделали замеры»<small>Фрагмент реального отзыва</small></blockquote><a class="review-source review-link" target="_blank" rel="noopener" href="https://yandex.ru/maps/org/mitta/1075173904"><span>Все отзывы на Яндексе</span><span>↗</span></a><p class="reputation-note">Показатели актуальны на 12.09.2026. Источник — Яндекс Карты.</p></div></div></section>
<section class="final-cta"><h2>Нашли<br>своё?</h2><div class="final-grid"><p class="final-copy">Откройте карточку товара и отправьте готовый вопрос в WhatsApp — магазин подтвердит актуальную цену и наличие.</p><div class="final-actions"><a class="btn light" href="/catalog/">Смотреть каталог</a><a class="btn light" href="/contacts/">Связаться</a></div></div></section>
</main>${footer()}`;
}
